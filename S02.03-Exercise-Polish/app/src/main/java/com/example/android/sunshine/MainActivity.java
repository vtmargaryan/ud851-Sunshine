...
public class MainActivity extends AppCompatActivity {
    ...
    ProgressBar mProgessIndicatorProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgessIndicatorProgressBar = (ProgressBar) findViewById(R.id.pb_progress_indicator);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgessIndicatorProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mProgessIndicatorProgressBar.setVisibility(View.INVISIBLE);
