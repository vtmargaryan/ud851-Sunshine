...
//  DONE (19) Create constant int values representing each column name's position above
    ...
    public static final int INDEX_WEATGER_DEGREES = 7;
...
//      DONE (26) Display a readable data string
        mDateTextView.setText(SunshineDateUtils.getFriendlyDateString(this,
                data.getInt(INDEX_WEATHER_DATE),
                false));
//      DONE (27) Display the weather description (using SunshineWeatherUtils)
        mDescriptionTextView.setText(SunshineWeatherUtils.getStringForWeatherCondition(this,
                data.getInt(INDEX_WEATHER_ID)));
//      DONE (28) Display the high temperature
        mMaxTempTextView.setText(Double.toString(data.getDouble(INDEX_WEATHER_MAX_TEMP)));
//      DONE (29) Display the low temperature
        mMinTempTextView.setText(Double.toString(data.getDouble(INDEX_WEATHER_MIN_TEMP)));
//      DONE (30) Display the humidity
        mHumidityTextView.setText(Double.toString(data.getDouble(INDEX_WEATHER_HUMIDITY)));
//      DONE (31) Display the wind speed and direction
        mWindTextView.setText(SunshineWeatherUtils.getFormattedWind(this,
                data.getFloat(INDEX_WEATHER_WIND_SPEED),
                data.getFloat(INDEX_WEATGER_DEGREES)));
//      DONE (32) Display the pressure
        mPressureTextView.setText(Double.toString(data.getDouble(INDEX_WEATHER_PRESSURE)));
//      DONE (33) Store a forecast summary in mForecastSummary
        mForecastSummary = SunshineWeatherUtils.formatHighLows(this,
